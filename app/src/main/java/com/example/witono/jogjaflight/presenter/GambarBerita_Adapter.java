 ...
 */
public class GambarBerita_Adapter extends PagerAdapter {
    ...
    public GambarBerita_Adapter(Context context, ArrayList<GambarBerita> imageModelArrayList) {
    ...
    public Object instantiateItem(ViewGroup view, int position) {
        View imageLayout = inflater.inflate(R.layout.slidingberita_layout, view, false);
